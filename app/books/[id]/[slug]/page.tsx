  ...
  return (
    <section className='container lg:px-2 px-5 min-h-screen lg:w-3/5 mx-auto py-10'>
      ...
      <section>
        <Link
          href='/'
          className='group relative inline-flex h-10 w-12 items-center justify-center overflow-hidden rounded-full bg-indigo-200 font-medium text-black transition-all duration-300 hover:w-32'
        >
